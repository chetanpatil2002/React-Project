      ...
      <div className="feacher-section p-2 ">
        ...
        <div className="image-section">
          <div className="div1">
            <p>Milk and Die</p>
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4wZwsqltBQTOxiM2mSl0aW9tmSbvr6ngujgQ3gRp27RwmP9CPS9uX-Rbk3gvoKJaApuI&usqp=CAU"
              alt=""
              style={{ height: "100px" }}
            />
            <p>3 items</p>
          ...
          <div className="div3">
            <p>Pet Toy</p>
            <img
              src="https://w7.pngwing.com/pngs/741/271/png-transparent-puppy-dog-food-pedigree-petfoods-milk-puppy-food-animals-pet-thumbnail.png"
              alt=""
              style={{ height: "100px" }}
            />
            <p>0 items</p>
          ...
          <div className="div4">
            <p>Baking Mate</p>
            <img
              src="https://png.pngtree.com/png-vector/20240127/ourlarge/pngtree-some-black-grapes-all-together-png-image_11561762.png"
              alt=""
              style={{ height: "100px" }}
            />
            <p>1 items</p>
          ...
          <div className="div5">
            <p>Baking MateS</p>
            <img
              src="https://png.pngtree.com/png-clipart/20191115/ourmid/pngtree-fresh-kiwi-fruits-isolated-on-transparent-png-image_1952934.jpg"
              alt=""
              style={{ height: "100px" }}
            />
            <p>1 items</p>
          ...
          <div className="div6">
            <p>Fresh Fruit</p>
            <img
              src="https://w7.pngwing.com/pngs/73/409/png-transparent-green-grapes-juice-grape-leaves-water-fruit-spray-grapes-food-photography-drop.png"
              alt=""
              style={{ height: "100px" }}
            />
            <p>1 items</p>
          ...
          <div className="div7">
            <p>Fresh Fruit</p>
            <img
              src="https://e7.pngegg.com/pngimages/1001/506/png-clipart-slices-of-oranges-orange-juice-flavor-fruit-nutritious-orange-natural-foods-food-thumbnail.png"
              alt=""
              style={{ height: "100px" }}
            />
            <p>1 items</p>
